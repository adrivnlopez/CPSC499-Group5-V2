  ...
  exercises: [
    {
      ...
      dropSets: [                                    // Optional drop sets
        {
          setNumber: { type: Number, required: true }, // Drop set sequential number
          reps: { type: Number, required: true },      // Reps in drop set
          weight: { type: Number, required: true },    // Weight in drop set
        },
      ],
    },
  ],
