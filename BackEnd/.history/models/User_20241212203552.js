...
const UserSchema = new mongoose.Schema(
  {
    ...
    nutritionLogs: [{ type: mongoose.Schema.Types.ObjectId, ref: 'NutritionLog' }], // Reference to nutrition logs
    workoutPlans: [{ type: mongoose.Schema.Types.ObjectId, ref: 'WorkoutPlan' }],   // Reference to workout plans
  },
